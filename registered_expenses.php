                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT expenses_major.*,expenses_categories.name as category_name,agencies.agency_name FROM `expenses_major` LEFT JOIN expenses_categories on expenses_categories.id = expenses_major.ex_cat_id LEFT JOIN agencies ON agencies.id = expenses_major.agency_id");
