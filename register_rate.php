                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> ثبت نرخ</li>
                        </ol>
                    </div>
                    <p class="page-title">صفحه ثبت نرخ</pack>
                </div> 
                <!-- end page title -->
                        ...
                        <div class="card-box">
                            ...
                            <form   method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-2">
                                    <label for="rate_agency_admin_id" class="col-form-label"> نمایندگی </label>
                                    <span class="text-danger">*</span>
                                    <select class="form-control js-example-basic-single" id="rate_agency_admin_id" name="rate_agency_admin_id">
                                        <?php 
                                ...
                                <div class="form-group col-md-2">
                                    <label for="good_id" class="col-form-label">کالا</label>
                                    <span class="text-danger">*</span>
                                    <select class="form-control " id="js-example-basic-single" id="good_id" name="good_id">
                                        <?php 
                                ...
                                <div class="form-group col-md-2">
                                    <label for="purchase_rate" class="col-form-label">  نرخ خرید (فی کیلو)</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control border border-dark" data-toggle="input-mask" name="purchase_rate" oninvalid="this.setCustomValidity('این بخش الزامی میباشد')" oninput="this.setCustomValidity('')" required id="purchase_rate" placeholder="بنویسید .. ">
                                </div>
                                <div class="form-group col-md-2">
                                    <label for="sale_rate" class="col-form-label"> نرخ فروش (فی کیلو)</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control border border-dark" data-toggle="input-mask" name="sale_rate" oninvalid="this.setCustomValidity('این بخش الزامی میباشد')" oninput="this.setCustomValidity('')" required id="sale_rate" placeholder="بنویسید .. ">
                                </div>
