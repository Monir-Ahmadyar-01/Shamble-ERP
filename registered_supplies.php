    ...
    <body>
                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> نمایش لوزام نمایندگی</li>
                        </ol>
                    </div>
                    <p class="page-title">نمایش لوزام نمایندگی</pack>
                </div> 
                <!-- end page title -->
                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT supplies.*,agencies.agency_name as agency_name FROM supplies LEFT JOIN agencies ON agencies.id = supplies.agency_id");
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row["feyat"]; ?></td>
                                            <td class="text text-success"><?php echo $row["quantity"] * $row["feyat"]; ?></td>
        ...
        <script>
            ...
            if(confirm == true)
            {
                ...
                window.open("registered_supplies.php",'_self');            
