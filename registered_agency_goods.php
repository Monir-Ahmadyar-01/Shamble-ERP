    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <a href="registered_agency_goods_major_unit.php"><button class="btn btn-primary btn-sm">نمایش گدام به اساس واحد اصلی</button></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td class="text text-danger"><?php echo $row["amount"]; ?></td>
