                        ...
                        <div class="card-box">
                            ...
                            <form   method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" class="form-control border border-dark" data-toggle="input-mask" name="expenses_category" oninvalid="this.setCustomValidity('این بخش الزامی میباشد')" oninput="this.setCustomValidity('')" required id="expenses_category" placeholder="بنویسید .. ">
                                </div>
                                <div class="form-group col-md-2">
                                    <label for="category_agency_id" class="col-form-label"> نمایندگی </label>
                                    <span class="text-danger">*</span>
                                    <select class="form-control js-example-basic-single" id="category_agency_id" name="category_agency_id">
                                        <?php 
