                        ...
                        <div class="card-box">
                            ...
                            <form   method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-2">
                                    <label for="good_agency_admin_id" class="col-form-label"> نمایندگی </label>
                                    <span class="text-danger">*</span>
                                    <select class="form-control js-example-basic-single" id="good_agency_admin_id" name="good_agency_admin_id">
                                        <?php 
                                ...
                                <div class="form-group col-md-3">
                                    <label for="unit_id" class="col-form-label">واحد</label>
                                    <span class="text-danger">*</span>
                                    <select class="form-control " id="js-example-basic-single_2" id="unit_id" name="unit_id">
                                        <?php 
                                        $sql_query_001 = mysqli_query($connection,"select id,unit_name from minor_units");
                                        while ($row = mysqli_fetch_assoc($sql_query_001)) 
                                        {
