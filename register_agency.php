                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> ثبت نمایندگی</li>
                        </ol>
                    </div>
                    <p class="page-title">صفحه ثبت نمایندگی</pack>
                </div> 
                <!-- end page title -->
                        ...
                        <div class="card-box">
                            ...
                            <form   method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-2">
                                    <label for="agency_name" class="col-form-label"> نام نمایندگی</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control border border-dark" data-toggle="input-mask" name="agency_name" oninvalid="this.setCustomValidity('این بخش الزامی میباشد')" oninput="this.setCustomValidity('')" required id="phone_number" placeholder="بنویسید .. ">                                    </div>
                                
                                <div class="form-group col-md-2">
                                    <label for="agency_admin_id" class="col-form-label">مدیر نمایندگی </label>
                                    <span class="text-danger">*</span>
                                    <select class="form-control js-example-basic-single" id="agency_admin_id" name="agency_admin_id">
                                        <?php 
                                        $sql_query_001 = mysqli_query($connection,"select id,full_name from stuff");
                                    ...
                                    <div class="form-group col-md-2">
                                        <label for="agency_type" class="col-form-label"> نوعیت نمایندگی</label>
                                        <span class="text-danger">*</span>
                                        <select class="form-control" id="agency_type" name="agency_type">
                                           
                                            <option value="موقعیتی">موقعیتی</option>
                                            <option value="موتری">موتری</option>
