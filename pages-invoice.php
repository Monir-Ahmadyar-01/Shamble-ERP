                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">صفحه بل</li>
                        </ol>
                    </div>
                    <p class="page-title">صفحه بل</pack>
                </div> 
                <!-- end page title -->
                                                ...
                                                <tr>
                                                    <th class="print-display"> 
                                                        <select name="customer_type" class="selectpicker" id="customer_type" data-style="btn-danger" id="">
                                                            <option value="temp_client">مشتری  موقتی</option>
                                                            <option value="major_client">مشتری  دایمی</option>
                                                        </select>
                                                    </th>
                                                    <th>
                                                        <p style="text-align:center; font-size:25px;" for="search_input_id">مشتری : </p>
                                                    
                                                    </th>
                                                    <th colspan="8">
                                                        <input type="search" id="major_customer_id" list="customers_major_list" class="form-control"  required
                                                                placeholder="جستجو مشتری دایمی "/>
                                                        ...
                                                        <datalist id="customers_major_list">
                                                            ...
                                                            ?>
                                                                ...
                                                                <option value="<?php echo $row["full_name"].' - آی دی:' . $row["id"]; ?>"><?php echo $row["full_name"]; ?></option>
                                                            <?php
                                                                }
                                                            ?>
                                                        </datalist>
                                                        ...
                                                        placeholder="اسم مشتری را بنویسید .. "/>
                                                    </th>
                                                </tr>
                                            <tr>
                                                ...
                                                <th style="width: 20%">واحد فروش</th>
                                                <th style="width: 10%" class="text-right">فیات کیلو</th>
                                                <th style="width: 10%" class="text-right">فیات واحد فروش</th>
                                                <th style="width: 10%" class="text-right print-display">تخفیف</th>
