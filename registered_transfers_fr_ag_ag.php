                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> نمایش  صفحه انتقالات از نمایندگی به نمایندگی </li>
                        </ol>
                    </div>
                    <p class="page-title">  نمایش   صفحه انتقالات از نمایندگی به نمایندگی</pack>
                </div> 
                <!-- end page title -->
                    ...
                    <div class="col-12">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                            ...
                            <div id="accordion">
                                <?php
                                    $count = 1;
                                    $sql_query_001 = mysqli_query($connection,"SELECT * FROM `transfer_fr_agency_to_agencies_major` order by id desc");
                                                    ...
                                                    <table class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $parent_id = $row["id"];
                                                                $count_2 = 1;
                                                                $sql_query_004 = mysqli_query($connection,"SELECT * FROM `transfer_fr_agency_to_agencies_minor` LEFT JOIN minor_units ON transfer_fr_agency_to_agencies_minor.unit_id = minor_units.id where transfer_major_id='$parent_id'");
