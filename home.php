            ...
            <div class="container-fluid">
                ...
                <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-centered table-hover mb-0" id="datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/avatar.jpg" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                        ...
                                        <tr>
                                            <td>
                                                <img src="assets/images/users/avatar0.jpg" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                    ...
                    <div class="col-xl-3">
                        ...
                        <div class="card-box">
                            <div class="media">
                                <img class="mr-3 rounded-circle bx-shadow-lg" src="assets/images/users/avatar.jpg" alt="Generic placeholder image" height="80">
