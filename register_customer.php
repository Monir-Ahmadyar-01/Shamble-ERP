                            ...
                            <form   method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" class="form-control  border border-dark" name="customer_full_name" oninvalid="this.setCustomValidity('این بخش الزامی میباشد')" oninput="this.setCustomValidity('')" required id="customer_full_name" placeholder="بنویسید .. ">
                                    </div>
                                    <div class="form-group col-md-2">
                                    ...
                                    <div class="form-group col-md-2">
                                    <label for="customer_agency_id" class="col-form-label"> نمایندگی </label>
                                    <span class="text-danger">*</span>
                                    <select class="form-control js-example-basic-single" id="customer_agency_id" name="customer_agency_id">
                                        <?php 
