                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> نمایش  نرخ ها </li>
                        </ol>
                    </div>
                    <p class="page-title">  نمایش   نرخ ها</pack>
                </div> 
                <!-- end page title -->
                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT rates_tb.*,agencies.agency_name,stock_minor.item_name FROM `rates_tb` LEFT JOIN agencies on agencies.id = rates_tb.agency_id LEFT JOIN stock_minor ON stock_minor.id = rates_tb.item_stock_minor_id");
                                        ...
                                        <tr>
                                            ...
                                            <td class="text text-danger"><?php echo $row["purchase_rate"]; ?></td>
