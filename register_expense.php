                        ...
                        <div class="card-box">
                            ...
                            <form   method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <div class="form-group col-md-2">
                                    <label for="expense_agency_id" class="col-form-label"> نمایندگی </label>
                                    <span class="text-danger">*</span>
                                    <select class="form-control js-example-basic-single" id="expense_agency_id" name="expense_agency_id">
                                        <?php 
