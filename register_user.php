                            ...
                            <form   method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="form-control js-example-basic-single" id="employee_id" name="employee_id">
                                            <?php 
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <span class="text-danger">*</span>
                                        <input type="text" class="form-control border border-dark" data-toggle="input-mask" name="user_name_employee" oninvalid="this.setCustomValidity('این بخش الزامی میباشد')" oninput="this.setCustomValidity('')" required id="phone_number" placeholder="بنویسید .. ">                                    </div>
                                    
                                    <div class="form-group col-md-2">
                                    <label for="password_employee" class="col-form-label"> رمز عبور (انگلیسی)</label>
                                    <span class="text-danger">*</span>
                                    <input type="password" class="form-control border border-dark" data-toggle="input-mask" name="password_employee" oninvalid="this.setCustomValidity('این بخش الزامی میباشد')" oninput="this.setCustomValidity('')" required id="phone_number" placeholder="بنویسید .. ">                                    </div>
